...
HD_PWD='E:/Youssef/GraduationProject/Github/Hardware-CNN-Acceleration-/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MaxComp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MaxComp.tcl
