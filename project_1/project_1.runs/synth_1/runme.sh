...
HD_PWD='E:/University/gp/verilog/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Convulution.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Convulution.tcl
