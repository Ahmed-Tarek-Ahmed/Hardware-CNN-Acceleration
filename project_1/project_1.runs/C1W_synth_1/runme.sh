...
HD_PWD='E:/University/gp/GITverilog/Hardware-CNN-Acceleration-/project_1/project_1.runs/C1W_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log C1W.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source C1W.tcl
