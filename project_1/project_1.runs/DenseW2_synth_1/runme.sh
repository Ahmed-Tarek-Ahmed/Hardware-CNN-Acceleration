...
HD_PWD='D:/work/college/5-Senior 2/Semester 2/Graduation Project 2/GP Codes/Hardware-CNN-Acceleration-/project_1/project_1.runs/DenseW2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DenseW2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DenseW2.tcl
