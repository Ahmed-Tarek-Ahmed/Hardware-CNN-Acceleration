...
HD_PWD='D:/work/college/5-Senior 2/Semester 2/Graduation Project 2/GP Codes/Hardware-CNN-Acceleration-/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Sequential_model.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Sequential_model.tcl -notrace
