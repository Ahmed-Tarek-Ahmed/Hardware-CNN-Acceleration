...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force Top_Sequential_model_opt.dcp
  create_report "impl_1_opt_report_drc_0" "report_drc -file Top_Sequential_model_drc_opted.rpt -pb Top_Sequential_model_drc_opted.pb -rpx Top_Sequential_model_drc_opted.rpx"
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force Top_Sequential_model_placed.dcp
  create_report "impl_1_place_report_io_0" "report_io -file Top_Sequential_model_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file Top_Sequential_model_utilization_placed.rpt -pb Top_Sequential_model_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file Top_Sequential_model_control_sets_placed.rpt"
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force Top_Sequential_model_routed.dcp
  create_report "impl_1_route_report_drc_0" "report_drc -file Top_Sequential_model_drc_routed.rpt -pb Top_Sequential_model_drc_routed.pb -rpx Top_Sequential_model_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file Top_Sequential_model_methodology_drc_routed.rpt -pb Top_Sequential_model_methodology_drc_routed.pb -rpx Top_Sequential_model_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file Top_Sequential_model_power_routed.rpt -pb Top_Sequential_model_power_summary_routed.pb -rpx Top_Sequential_model_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file Top_Sequential_model_route_status.rpt -pb Top_Sequential_model_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file Top_Sequential_model_timing_summary_routed.rpt -pb Top_Sequential_model_timing_summary_routed.pb -rpx Top_Sequential_model_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file Top_Sequential_model_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file Top_Sequential_model_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file Top_Sequential_model_bus_skew_routed.rpt -pb Top_Sequential_model_bus_skew_routed.pb -rpx Top_Sequential_model_bus_skew_routed.rpx"
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force Top_Sequential_model_routed_error.dcp
