...
#
# Generated by export_simulation on Sat May 14 20:17:33 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './DenseW3.sh' script.

./DenseW3.sh -reset_run
...
./DenseW3.sh -noclean_files

For more information on the script, please type './DenseW3.sh -help'.
