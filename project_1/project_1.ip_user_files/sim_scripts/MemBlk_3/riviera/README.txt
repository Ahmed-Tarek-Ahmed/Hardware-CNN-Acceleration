...
#
# Generated by export_simulation on Sat May 28 17:23:04 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './MemBlk_3.sh' script.

./MemBlk_3.sh -reset_run
...
./MemBlk_3.sh -noclean_files

For more information on the script, please type './MemBlk_3.sh -help'.
