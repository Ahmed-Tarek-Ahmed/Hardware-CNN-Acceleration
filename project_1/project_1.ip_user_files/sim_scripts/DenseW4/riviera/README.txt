...
#
# Generated by export_simulation on Tue May 31 20:43:24 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './DenseW4.sh' script.

./DenseW4.sh -reset_run
...
./DenseW4.sh -noclean_files

For more information on the script, please type './DenseW4.sh -help'.
