...
#
# Generated by export_simulation on Sat May 28 17:21:34 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './MemBlk_1.sh' script.

./MemBlk_1.sh -reset_run
...
./MemBlk_1.sh -noclean_files

For more information on the script, please type './MemBlk_1.sh -help'.
