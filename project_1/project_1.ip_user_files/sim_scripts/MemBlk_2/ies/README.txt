...
#
# Generated by export_simulation on Sat May 28 20:14:42 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './MemBlk_2.sh' script.

./MemBlk_2.sh -reset_run
...
./MemBlk_2.sh -noclean_files

For more information on the script, please type './MemBlk_2.sh -help'.
