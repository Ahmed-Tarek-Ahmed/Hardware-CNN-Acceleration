...
#
# Generated by export_simulation on Sat May 14 17:58:40 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './C1W.sh' script.
...
./C1W.sh -noclean_files

For more information on the script, please type './C1W.sh -help'.
