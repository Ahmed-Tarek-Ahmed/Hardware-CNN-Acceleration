...
#
# Generated by export_simulation on Sat May 14 20:17:42 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './DenseW0.sh' script.

./DenseW0.sh -reset_run
...
./DenseW0.sh -noclean_files

For more information on the script, please type './DenseW0.sh -help'.
