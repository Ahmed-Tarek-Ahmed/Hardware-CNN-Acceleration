...
#
# Generated by export_simulation on Tue May 31 20:41:16 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './DenseW1.sh' script.

./DenseW1.sh -reset_run
...
./DenseW1.sh -noclean_files

For more information on the script, please type './DenseW1.sh -help'.
