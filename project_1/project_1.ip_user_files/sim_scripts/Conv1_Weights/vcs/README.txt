...
#
# Generated by export_simulation on Tue May 31 20:52:18 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './Conv1_Weights.sh' script.

./Conv1_Weights.sh -reset_run
...
./Conv1_Weights.sh -noclean_files

For more information on the script, please type './Conv1_Weights.sh -help'.
