...
#
# Generated by export_simulation on Tue May 31 20:41:34 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './DenseW2.sh' script.

./DenseW2.sh -reset_run
...
./DenseW2.sh -noclean_files

For more information on the script, please type './DenseW2.sh -help'.
